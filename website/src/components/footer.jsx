    ...
    <>
      ...
      <div className="flex bg-[rgb(204,172,171)] h-[200px] ">
        ...
        <div
          ...
          className="flex flex-col justify-around p-4 ml-6 mt-10 mr-8 w-[21rem] h-32 bg-[rgb(51,51,51)] border-red-600 rounded-lg text-white text-center"
        >
          <p>Contacts :</p>
          <p>Creators :</p>
        ...
        <div
          ...
          className="flex flex-col justify-around p-4 mt-10 mx-8 w-[21rem] h-32 bg-[rgb(51,51,51)] border-red-600 rounded-lg text-white text-center"
        >
          <p>Info :</p>
